...
public class RS256OrES256Endpoint {
    ...
    private String getAlgorithm() {
        String encodedHeaders = rawToken.getValue().split("\\.")[0];
        String headersJson = new String(Base64.getUrlDecoder().decode(encodedHeaders));
        JsonReader jsonReader = Json.createReader(new StringReader(headersJson));
